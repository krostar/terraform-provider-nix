...
func newDataSourceStorePath() datasource.DataSource {
	return &dataSourceStorePath{}
}

func (d *dataSourceStorePath) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_store_path"
}

func (d *dataSourceStorePath) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
